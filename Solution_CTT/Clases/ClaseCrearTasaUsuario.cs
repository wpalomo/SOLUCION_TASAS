...
{
    public class ClaseCrearTasaUsuario
    {
        ...
        public bool tasa(string sCantidad, string[] sDatos)
        {
            try
            {
                sDatosMaximo = sDatos;
                ...
                sObjetoInfo += "\"str_horaSalida\": \"" + "19:00" + "\"," + Environment.NewLine;
                sObjetoInfo += "\"str_fechaSalida\": \"" + DateTime.Now.ToString("yyyy-MM-dd") + "\"," + Environment.NewLine;
                ...
                sObjetoCliente += "\"direccion\": \"" + "QUITO" + "\"," + Environment.NewLine;
