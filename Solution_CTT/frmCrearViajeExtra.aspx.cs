...
{
    public partial class frmCrearViajeExtra : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Session["modulo"] = "MÓDULO PARA CREAR VIAJES EXTRAS";
        ...
        private void consultarIdExtra()
        {
            try
            {
                ...
                sSql += "where extra = 1" + Environment.NewLine;
                sSql += "and estado = 'A'";
        ...
        private void llenarGrid(string sFecha_P)
        {
            try
            {
                ...
                sSql = "";
                sSql += "select * from ctt_vw_crear_programacion_extras" + Environment.NewLine;
        ...
        private void insertarRegistro()
        {
            try
            {
                ...
                Session["horaSMARTT"] = Convert.ToDateTime(txtHoraSalida.Text.Trim()).ToString("HH:mm");
                ...
                sSql += "hora_reemplazo_extra, cobrar_administracion, id_ctt_pueblo_origen, id_viaje_contifico, estado," + Environment.NewLine;
                ...
                sSql += iIdVIajeAPI + ", 'A', GETDATE(), '" + sDatosMaximo[0] + "', '" + sDatosMaximo[1] + "')";
        ...
        protected void btnGuardar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    ScriptManager.RegisterStartupScript(this, GetType(), "Popup", "swal('Información.!', 'Favor ingrese la hora de salida del viaje.', 'warning');", true);
                    txtHoraSalida.Focus();
                }
        ...
        {
            Response.Redirect("frmCrearViajeExtra.aspx");
        }
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (sAccion == "Editar")
                    {
                        ...
                        txtHoraSalida.Text = dgvDatos.Rows[a].Cells[7].Text.Trim();
