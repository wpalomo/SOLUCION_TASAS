...
{
    public partial class frmTipoAsientos : System.Web.UI.Page
    {
        ENTTipoAsiento tipoAsientoE = new ENTTipoAsiento();
        manejadorTipoAsiento tipoAsientoM = new manejadorTipoAsiento();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Session["modulo"] = "MÓDULO DE TIPO DE ASIENTOS";
        ...
        private void llenarGrid(int iOp)
        {
            ...
            {
                sSql = "";
                sSql += "select id_ctt_tipo_asiento, codigo, descripcion," + Environment.NewLine;
                ...
                sSql += "order by id_ctt_tipo_asiento" + Environment.NewLine;

                columnasGrid(true);
                tipoAsientoE.ISSQL = sSql;
                dgvDatos.DataSource = tipoAsientoM.listarTipoAsiento(tipoAsientoE);
                dgvDatos.DataBind();
                columnasGrid(false);
        ...
        private void insertarRegistro()
        {
            try
            {
                ...
                sSql = "";
                sSql += "insert into ctt_tipo_asiento (" + Environment.NewLine;
        ...
        private void actualizarRegistro()
        {
            try
            {
                ...
                sSql = "";
                sSql += "update ctt_tipo_asiento set" + Environment.NewLine;
                ...
                sSql += "where id_ctt_tipo_asiento = " + Convert.ToInt32(Session["idRegistro"]) + Environment.NewLine;
                sSql += "and estado = 'A'";
        ...
        private void eliminarRegistro()
        {
            try
            {
                ...
                sSql += "where id_ctt_tipo_asiento = " + Convert.ToInt32(Session["idRegistro"]);
