...
{
    public partial class frmNumeroDisco : System.Web.UI.Page
    {
        ENTDisco discoE = new ENTDisco();
        manejadorDisco discoM = new manejadorDisco();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Session["modulo"] = "MÓDULO DE DISCOS DE BUSES";
        ...
        private void llenarGrid(int iOp)
        {
            ...
            {
                sSql = "";
                sSql += "select id_ctt_disco, codigo, descripcion," + Environment.NewLine;
                ...
                columnasGrid(true);
                discoE.ISSQL = sSql;
                dgvDatos.DataSource = discoM.listarDisco(discoE);
                dgvDatos.DataBind();
                columnasGrid(false);
            }
        ...
        private void insertarRegistro()
        {
            try
            {
                ...
                sSql = "";
                sSql += "insert into ctt_disco (" + Environment.NewLine;
        ...
        private void actualizarRegistro()
        {
            try
            {
                ...
                sSql = "";
                sSql += "update ctt_disco set" + Environment.NewLine;
                ...
                sSql += "where id_ctt_disco = " + Convert.ToInt32(Session["idRegistro"]) + Environment.NewLine;
                sSql += "and estado = 'A'";
        ...
        private void eliminarRegistro()
        {
            try
            {
                ...
                sSql += "where id_ctt_disco = " + Convert.ToInt32(Session["idRegistro"]);
