...
namespace Solution_CTT
{
    public partial class frmPrecios : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Session["modulo"] = "MÓDULO DE PRECIOS";
            Session["buscar"] = "";
        ...
        private void llenarComboOrigen()
        {
            try
            {
                ...
                sSql += "and P.cobros_tickets = 0" + Environment.NewLine;
        ...
        private void llenarGrid(int iOp)
        {
            ...
            {
                sSql = "";
                sSql += "select * from ctt_vw_lista_precios_pasajes" + Environment.NewLine;
        ...
        //FUNCION PARA EXTRAER EL PRECIO DE LA LISTA OTROS
        private void recuperarPrecioOtros(int iIdProducto_P)
        {
            try
            {
                sSql = "";
                sSql += "select isnull(ltrim(str(valor, 10, 2)), 0) valor" + Environment.NewLine;
                sSql += "from cv403_precios_productos" + Environment.NewLine;
                ...
                if (bRespuesta == true)
                {
                    ...
                    {
                        txtValorOtros.Text = "0.00";
                        Session["valorPasajeOtros"] = "0.00"; 
                    }

                    else
                    {
                        txtValorOtros.Text = dtConsulta.Rows[0][0].ToString();
                        Session["valorPasajeOtros"] = dgvDatos.Rows[0].Cells[0].Text;
                    }
                }
        ...
        private void insertarRegistro()
        {
            try
            {
                ...
                sSql += Convert.ToInt32(cmbOrigen.SelectedValue) + ", " + Convert.ToInt32(cmbDestino.SelectedValue) + ", 3, 0, 0, " + iPagaIva + "," + Environment.NewLine;
                ...
                //dbPrecioInsertar = Convert.ToDouble(txtValor.Text.Trim());
                ...
                sSql += Convert.ToDecimal(txtValor.Text.Trim()) + ", '" + DateTime.Now.ToString("yyyy/MM/dd") + "'," + Environment.NewLine;
                ...
                //dbPrecioInsertar = Convert.ToDouble(txtValorOtros.Text.Trim());
                ...
                sSql += Convert.ToDecimal(txtValorOtros.Text.Trim()) + ", '" + DateTime.Now.ToString("yyyy/MM/dd") + "'," + Environment.NewLine;
        ...
        private void actualizarRegistro()
        {
            try
            {
                ...
                //PROCEDIMIENTO PARA ACTUALIZAR EL PRECIO DEL PRODUCTO VALOR MINORISTA
        ...
        protected void dgvDatos_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                if (sAccion == "Editar")
                {
                    ...
                    //recuperarPrecioOtros(Convert.ToInt32(Session["idRegistro"].ToString()));
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            else if (txtValorOtros.Text.Trim() == "")
            {
                MsjValidarCampos.Visible = true;
                txtDescripcion.Focus();
            }
