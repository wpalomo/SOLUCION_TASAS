...
{
    public partial class frmModeloVehiculos : System.Web.UI.Page
    {
        ENTModeloVehiculo modeloVehiculoE = new ENTModeloVehiculo();
        manejadorModeloVehiculo modeloVehiculoM = new manejadorModeloVehiculo();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Session["modulo"] = "MÓDULO DE MODELO DE VEHÍCULOS";
        ...
        private void llenarGrid(int iOp)
        {
            ...
            {
                sSql = "";
                sSql += "select id_ctt_modelo_vehiculo, codigo, descripcion," + Environment.NewLine;
                ...
                sSql += "order by id_ctt_modelo_vehiculo" + Environment.NewLine;

                columnasGrid(true);
                modeloVehiculoE.ISSQL = sSql;
                dgvDatos.DataSource = modeloVehiculoM.listarModeloVehiculo(modeloVehiculoE);
                dgvDatos.DataBind();
                columnasGrid(false);
        ...
        private void insertarRegistro()
        {
            try
            {
                ...
                sSql = "";
                sSql += "insert into ctt_modelo_vehiculo (" + Environment.NewLine;
        ...
        private void actualizarRegistro()
        {
            try
            {
                ...
                sSql = "";
                sSql += "update ctt_modelo_vehiculo set" + Environment.NewLine;
                ...
                sSql += "where id_ctt_modelo_vehiculo = " + Convert.ToInt32(Session["idRegistro"]) + Environment.NewLine;
                sSql += "and estado = 'A'";
        ...
        private void eliminarRegistro()
        {
            try
            {
                ...
                sSql += "where id_ctt_modelo_vehiculo = " + Convert.ToInt32(Session["idRegistro"]);
