        ...
        protected void dgvDatos_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                reporte.llenarReporte(Convert.ToDateTime(dgvDatos.Rows[a].Cells[1].Text).ToString("yyyy-MM-dd"),
                                      Convert.ToInt32(Session["idJornada"].ToString()), dgvDatos.Rows[a].Cells[5].Text.ToUpper(), dgvDatos.Rows[a].Cells[4].Text, dtConsulta, Convert.ToInt32(Session["idUsuario"].ToString()), 0, iIdCierreCaja);
