...
{
    public class ClaseConsultaViajes
    {
        ...
        public string recuperarJson(string sToken_P, string sFiltro_P)
        {
            try
            {
                ...
                {
                    sUrlViajes = dtConsulta.Rows[0]["api_viajes_contifico"].ToString().Trim() + "?" + sFiltro_P;
                }
