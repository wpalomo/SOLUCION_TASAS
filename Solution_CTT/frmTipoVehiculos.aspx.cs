...
{
    public partial class frmTipoVehiculos : System.Web.UI.Page
    {
        ENTTipoVehiculo tipoVehiculoE = new ENTTipoVehiculo();
        manejadorTipoVehiculo tipoVehiculoM = new manejadorTipoVehiculo();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Session["modulo"] = "MÓDULO DE TIPO DE VEHÍCULOS";
        ...
        private void llenarGrid(int iOp)
        {
            ...
            {
                sSql = "";
                sSql += "select id_ctt_tipo_vehiculo, codigo, descripcion," + Environment.NewLine;
                ...
                sSql += "order by id_ctt_tipo_vehiculo" + Environment.NewLine;

                columnasGrid(true);
                tipoVehiculoE.ISSQL = sSql;
                dgvDatos.DataSource = tipoVehiculoM.listarTipoVehiculo(tipoVehiculoE);
                dgvDatos.DataBind();
                columnasGrid(false);
        ...
        private void insertarRegistro()
        {
            try
            {
                ...
                sSql = "";
                sSql += "insert into ctt_tipo_vehiculo (" + Environment.NewLine;
        ...
        private void actualizarRegistro()
        {
            try
            {
                ...
                sSql = "";
                sSql += "update ctt_tipo_vehiculo set" + Environment.NewLine;
                ...
                sSql += "where id_ctt_tipo_vehiculo = " + Convert.ToInt32(Session["idRegistro"]) + Environment.NewLine;
                sSql += "and estado = 'A'";
        ...
        private void eliminarRegistro()
        {
            try
            {
                ...
                sSql += "where id_ctt_tipo_vehiculo = " + Convert.ToInt32(Session["idRegistro"]);
