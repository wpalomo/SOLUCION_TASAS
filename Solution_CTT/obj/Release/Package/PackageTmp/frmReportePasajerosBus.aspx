<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="frmReportePasajerosBus.aspx.cs" Inherits="Solution_CTT.frmReportePasajerosBus" %>
            ...
            <section class="content">
                <div class="row">
                            ...
                            <div class="box-body">
                                <div class="form-group">
                                    <div class="row">                                
                                        ...
                                        <div class="col-md-3">
                                            <asp:Label ID="Label4" runat="server" Text="Terminal de salida"></asp:Label>
                                            <asp:DropDownList ID="cmbTerminal" runat="server" class="form-control"></asp:DropDownList>
                                        </div>                                     
                                    </div>
                                </div>
                    ...
                    <div class="box-footer">
                         <asp:GridView ID="dgvDatos" runat="server" class="mGrid" AutoGenerateColumns="False" EmptyDataText="No hay Registros o Coindicencias..!!" OnSelectedIndexChanged="dgvDatos_SelectedIndexChanged" AllowPaging="True" OnPageIndexChanging="dgvDatos_PageIndexChanging" PageSize="10" OnRowDataBound="dgvDatos_RowDataBound">
                            <Columns>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-10">
                                    <rsweb:ReportViewer ID="rptReportePasajerosBus" runat="server" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Height="400px" Width="850px">
                                    <LocalReport ReportEmbeddedResource="Solution_CTT.Reportes.rptPasajerosLocalidades.rdlc">
                                    </LocalReport>
                                    </rsweb:ReportViewer>
                                    <br />
                                </div>
