<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="frmGenerarToken.aspx.cs" Inherits="Solution_CTT.frmGenerarToken" %>
                        ...
                        <div class="col-xs-12">
                            <div class="box box-primary">
                                <div class="box-header with-border">
                                    ...
                                    <h3 class="box-title">Generación de Token - Tasa de Usuario</h3>
                                ...
                                <div class="box-footer">
                                    <asp:Button ID="btnGenerar" runat="server" Text="Generar Token" class="btn btn btn-warning" OnClick="btnGenerar_Click" />
                                    <asp:Button ID="btnGuardar" runat="server" Text="Guardar Token Generado" class="btn btn btn-warning" Enabled="false" OnClick="btnGuardar_Click" />
