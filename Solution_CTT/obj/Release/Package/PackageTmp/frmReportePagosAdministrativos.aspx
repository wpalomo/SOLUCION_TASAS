<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="frmReportePagosAdministrativos.aspx.cs" Inherits="Solution_CTT.frmReportePagosAdministrativos" %>
                    ...
                    <div class="box-footer">
                         <asp:GridView ID="dgvDatos" runat="server" class="mGrid" AutoGenerateColumns="False" EmptyDataText="No hay Registros o Coindicencias..!!" AllowPaging="True" OnPageIndexChanging="dgvDatos_PageIndexChanging" PageSize="10">
                            <Columns>
                                ...
                                <asp:BoundField DataField="IPROPIETARIO" HeaderText="PROPIETARIO" ItemStyle-HorizontalAlign="Center" />
