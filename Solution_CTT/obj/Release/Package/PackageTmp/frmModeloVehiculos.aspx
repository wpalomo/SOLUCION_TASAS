<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="frmModeloVehiculos.aspx.cs" Inherits="Solution_CTT.frmModeloVehiculos" %>
                ...
                <div class="col-md-8">
                  ...
                  <<div class="col-md-4">
                        <div class="box box-success">
                            <div class="box-header with-border">
                                <h3 class="box-title"><%= Resources.MESSAGES.TXT_MODELO_VEHICULO %></h3>
                                <div class="box-tools pull-right">
