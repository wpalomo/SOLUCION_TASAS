<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="frmDetalleRuta.aspx.cs" Inherits="Solution_CTT.frmDetalleRuta" %>
                ...
                <div class="row">
                            ...
                            <div class="box-body">
                                <asp:GridView ID="dgvDatos" runat="server" class="mGrid" AutoGenerateColumns="False" EmptyDataText="No hay Registros o Coindicencias..!!" OnSelectedIndexChanged="dgvDatos_SelectedIndexChanged" AllowPaging="true" PageSize="8" OnPageIndexChanging="dgvDatos_PageIndexChanging">
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="IORIGEN" HeaderText="ORIGEN" />
                    ...
                    <div class="col-md-4">
                        <div class="box box-success">
                            <div class="box-header with-border">
                                <h3 class="box-title"><%= Resources.MESSAGES.TXT_DETALLE_RUTA %></h3>
                                <div class="box-tools pull-right">
                                ...
                                <div class="register-box-body">
                                    <div class="row">
                                        <div class="col-md-offset-1 col-md-10">
                                            ...
                                            <div class="form-group has-feedback">
                                                <asp:TextBox ID="txtPrecio" runat="server" CssClass="form-control" placeholder="Precio *" Onkeypress="return ValidaDecimal(this.value);"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
