<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="frmDefinicionCortaLocalidades.aspx.cs" Inherits="Solution_CTT.frmDefinicionCortaLocalidades" %>
                    ...
                    <div class="col-md-7">
                        <div class="box box-primary">
                            <div class="box-header with-border">
                                ...
                                <h3 class="box-title">Definición Corta de Localidades</h3>

                                <div class="box-tools pull-right">
                                    <div class="input-group input-group-sm" style="width: 150px;">
                                        <asp:RadioButton ID="rdbActivos" runat="server" Text="Activos" Checked="true" GroupName="Opciones" OnCheckedChanged="rdbActivos_CheckedChanged" AutoPostBack="true" />
                                        <asp:RadioButton ID="rdbTodos" runat="server" Text="Todos" GroupName="Opciones" OnCheckedChanged="rdbTodos_CheckedChanged" AutoPostBack="true" />
                                    </div>
                                </div>
                            </div>
                            <div class="box-body">
                                <asp:GridView ID="dgvDatos" runat="server" class="mGrid" AutoGenerateColumns="False" EmptyDataText="No hay Registros o Coindicencias..!!" OnSelectedIndexChanged="dgvDatos_SelectedIndexChanged" AllowPaging="true" PageSize="10" OnPageIndexChanging="dgvDatos_PageIndexChanging">
                                    <Columns>
                                        <asp:BoundField DataField="correlativo" HeaderText= "CORRELATIVO" ItemStyle-HorizontalAlign="Center" />
                                        <asp:BoundField DataField="codigo" HeaderText="CÓDIGO" />
                                        <asp:BoundField DataField="valor_texto" HeaderText="DESCRIPCIÓN" />
                                ...
                                <div class="register-box-body">
                                    <div class="row">
                                        <div class="col-md-offset-1 col-md-10">
                                            ...
                                            <div class="form-group has-feedback">
                                                <asp:TextBox ID="txtDescripcion" runat="server" CssClass="form-control" Autocomplete="off" placeholder="Descripción *"></asp:TextBox>                                                
                                            </div>
