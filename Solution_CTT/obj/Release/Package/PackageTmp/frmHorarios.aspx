<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="frmHorarios.aspx.cs" Inherits="Solution_CTT.frmHorarios" %>
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="box-body">
                            <asp:GridView ID="dgvDatos" runat="server" class="mGrid" AutoGenerateColumns="False" EmptyDataText="No hay Registros o Coindicencias..!!" OnSelectedIndexChanged="dgvDatos_SelectedIndexChanged" AllowPaging="true" PageSize="8" OnPageIndexChanging="dgvDatos_PageIndexChanging">
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="IIDJORNADA" HeaderText="ID" />
                                    <asp:BoundField DataField="ICODIGO" HeaderText="CÓDIGO" ItemStyle-HorizontalAlign="Center"  />
                                    <asp:BoundField DataField="IHORASALIDA" HeaderText="HORA DE SALIDA" ItemStyle-HorizontalAlign="Center" />
                      ...
                      <div class="col-md-4">
                          <div class="box box-success">
                              <div class="box-header with-border">
                                  <h3 class="box-title"><%= Resources.MESSAGES.TXT_HORARIOS %></h3>
                                  <div class="box-tools pull-right">
                              ...
                              <div class="register-box-body">
                                  <div class="row">
                                      <div class="col-md-offset-1 col-md-10">
                                          ...
                                          <div class="form-group has-feedback">
                                              <asp:DropDownList ID="cmbJornadas" runat="server" class="form-control"></asp:DropDownList>
                                          </div>
                                      </div>
                                  </div>
                                  <div class="row">
