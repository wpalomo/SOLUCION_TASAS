<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="frmImpresoras.aspx.cs" Inherits="Solution_CTT.frmImpresoras" %>
                ...
                <div class="row">
                        ...
                        <div class="box box-primary">
                            ...
                            <div class="box-body">
                                <asp:GridView ID="dgvDatos" runat="server" class="mGrid" AutoGenerateColumns="False" EmptyDataText="No hay Registros o Coindicencias..!!" OnSelectedIndexChanged="dgvDatos_SelectedIndexChanged" AllowPaging="true" PageSize="8" OnPageIndexChanging="dgvDatos_PageIndexChanging">
                                    <Columns>
                                        <asp:BoundField DataField="IIDIMPRESORA" HeaderText="ID" />
                                        <asp:BoundField DataField="IDESCRIPCION" HeaderText="DESCRIPCIÓN"/>
                                        <asp:BoundField DataField="IPATH" HeaderText="PATH"/>
                                        <asp:BoundField DataField="ICORTARPAPEL" HeaderText="CORTAR PAPEL" />
                                        <asp:BoundField DataField="IABRIRCAJON" HeaderText="ABRIR CAJÓN" />
                                        <asp:BoundField DataField="INUMEROIMPRESION" HeaderText="NUMERO IMPRESIONES" />
                                        <asp:BoundField DataField="IIDLOCALIDAD" HeaderText="IDLOCALIDAD" />
                                        <asp:BoundField DataField="IIDPUEBLO" HeaderText="IDPUEBLO" />
                                        <asp:BoundField DataField="IPUEBLO" HeaderText="TERMINAL" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center"/>
                                        <asp:BoundField DataField="IIPLOCAL" HeaderText="IP LOCAL" />
                                        <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderText="EDITAR" HeaderStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderText="BORRAR" HeaderStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                    ...
                    <div class="col-md-4">
                        <div class="box box-success">
                            <div class="box-header with-border">
                                <h3 class="box-title"><%= Resources.MESSAGES.TXT_IMPRESORAS %></h3>
                                <div class="box-tools pull-right">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <asp:DropDownList ID="cmbPueblos" runat="server" class="form-control" AutoPostBack="true" OnSelectedIndexChanged="cmbPueblos_OnSelectedIndexChanged"></asp:DropDownList>                                                        
                                                    </div>
                                                </div>
                                            </div>

                                            <asp:Panel ID="pnlImpresoras" runat="server" Visible="false">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <asp:DropDownList ID="cmbImpresoras" runat="server" class="form-control"></asp:DropDownList>                                                        
                                                        </div>
                                                    </div>
                                                </div>
                                                <%--<div class="form-group has-feedback">
                                                    <asp:TextBox ID="txtDescripcion" runat="server" CssClass="form-control" placeholder="Descripción de Impresora" Style="text-transform: uppercase" autocomplete="off"></asp:TextBox>
                                                </div>--%>
                                                <div class="form-group has-feedback">
                                                    <asp:TextBox ID="txtCantidad" runat="server" CssClass="form-control" placeholder="N° de Impresiones" onkeypress="return validar_numeros(event)"></asp:TextBox>
                                                </div>

                                                <div class="form-group has-feedback">
                                                    <asp:TextBox ID="txtIpLocal" runat="server" CssClass="form-control" autocomplete="off" placeholder="IP LOCAL *" ToolTip="Debe buscar un asistente, haciendo click en el boton verde buscar asistente"></asp:TextBox>
                                                </div>
                                                <%--<div class="form-group has-feedback">
                                                    <asp:LinkButton ID="btnSeleccionarIP" runat="server" Text="" class="btn btn-block btn-success" OnClick="btnSeleccionarIP_Click"><i class="fa fa-search"> SELECCIONAR IP LOCAL</i></asp:LinkButton>
                                                </div>--%>

                                                <div class="form-group has-feedback">
                                                    <asp:CheckBox ID="chkCortarPapel" runat="server" Text="&nbsp;&nbsp;Cortar el Papel" />
                                                </div>
                                                <div class="form-group has-feedback">
                                                    <asp:CheckBox ID="chkAbrirCajon" runat="server" Text="&nbsp;&nbsp;Abrir Cajón de Dinero" />
                                                </div>
                                            </asp:Panel>                                            
                                        </div>
                                    </div>
