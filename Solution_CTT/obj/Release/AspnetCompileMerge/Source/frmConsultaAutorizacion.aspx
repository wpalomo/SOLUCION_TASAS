<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="frmConsultaAutorizacion.aspx.cs" Inherits="Solution_CTT.frmConsultaAutorizacion" %>
                    ...
                    <div class="col-md-12">
                        <div class="box box-primary">
                            <div class="box-header with-border">
                                ...
                                <h3 class="box-title">Consulta de Comprobantes</h3>
                            </div>
                            <div class="box-body">
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-3 form-group">
                                        <label>Ruta de archivos Autorizados</label>
                                        <div class="input-group col-sm-12">
                                            <asp:TextBox ID="txtRutaAutorizados" runat="server" class="form-control input-sm" placeholder="" AutoComplete="off" disabled="" ToolTip="Este campo es generado automático"></asp:TextBox>
                                            <span class="input-group-addon input-sm"><i class="fa fa-dollar"></i></span>
                                        </div>
                                    </div>
                                    <div class="col-md-3 form-group">
                                        <label>Archivo Autorizados</label>
                                        <div class="input-group col-sm-12">
                                            <asp:TextBox ID="txtDocumentoAutorizado" runat="server" class="form-control input-sm" placeholder="" AutoComplete="off" disabled="" ToolTip="Este campo es generado automático"></asp:TextBox>
                                            <span class="input-group-addon input-sm"><i class="fa fa-dollar"></i></span>
                                        </div>
                                    </div>                                 
                                </div>
                                <div class="box-header with-border">
                                    <h4 class="box-title">Respuesta de Autorización del SRI</h4>
                                </div>
                                <p></p>
                                <div class="row">
                                    <div class="col-md-3 form-group">
                                    ...
                                    <div class="col-md-3 form-group">
                                        <label>Autorización Estado</label>
                                        <div class="input-group col-sm-12">
                                            <asp:TextBox ID="txtAutorizacionEstado" runat="server" class="form-control input-sm" placeholder="" AutoComplete="off" disabled="" ToolTip="Este campo es generado automático"></asp:TextBox>
                                            <span class="input-group-addon input-sm"><i class="fa fa-dollar"></i></span>
                                        </div>
                                    </div>
                                    <div class="col-md-6 form-group">
                                        ...
                                        <div class="input-group col-sm-12">
                                            <asp:TextBox ID="txtNumeroAutorizacion" runat="server" class="form-control input-sm" placeholder="" AutoComplete="off" ToolTip="Este campo es generado automático"></asp:TextBox>
                                            <span class="input-group-addon input-sm"><i class="fa fa-dollar"></i></span>
                                        </div>
                                    </div> 
                                    <div class="col-md-6 form-group">
                                        ...
                                        <div class="input-group col-sm-12">
                                            <asp:TextBox ID="txtFechaAutorizacion" runat="server" class="form-control input-sm" placeholder="" AutoComplete="off"  ToolTip="Este campo es generado automático"></asp:TextBox>
                                            <span class="input-group-addon input-sm"><i class="fa fa-dollar"></i></span>
                                        </div>
                                    </div> 
                                    <div class="col-md-12 form-group">
                                        ...
                                        <div class="input-group col-sm-12">
                                            <asp:TextBox ID="txtDetalles_1" runat="server" class="form-control input-sm" placeholder="" AutoComplete="off" ToolTip="Este campo es generado automático"></asp:TextBox>
                                            <span class="input-group-addon input-sm"><i class="fa fa-dollar"></i></span>
                                        </div>
                                    </div>  
                                    <div class="col-md-12 form-group">
                                        <label>Detalles</label>
                                        <div class="input-group col-sm-12">
                                            <asp:TextBox ID="txtDetalles_2" runat="server" class="form-control input-sm" placeholder="" AutoComplete="off" ToolTip="Este campo es generado automático"></asp:TextBox>
                                            <span class="input-group-addon input-sm"><i class="fa fa-dollar"></i></span>
                                        </div>
                                    </div>                            
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-3 form-group">
                                        <label></label>
                                        <div class="input-group col-sm-12">
                                            <asp:LinkButton ID="lbtnEnviarXML" runat="server" class="form-control btn btn-flat btn-primary" ToolTip="Clic aquí, para validar XML" OnClick="lbtnEnviarXML_Click" ><i class="fa fa-pencil-square-o"></i>  Validar XML</asp:LinkButton>
                                        </div>
                                    </div>
                                    <div class="col-md-3 form-group">
                                        <label></label>
                    ...
                    <div class="modal-body">
                        <asp:Panel ID="Panel1" runat="server" DefaultButton="btnFiltarModalBuscarXML">
                            <div class="form-group">                            
                                <div class="row">
                                    <div class="col-md-8">
                                        <asp:TextBox ID="txtFiltrarModalBuscarXML" runat="server" class="form-control" placeholder="Número de Factura" Style="text-transform: uppercase"></asp:TextBox>
                                    </div>
                                    <div class="col-md-3">
                                        <asp:Button ID="btnFiltarModalBuscarXML" runat="server" Text="Buscar" class="btn btn-block btn-primary" OnClick="btnFiltarModalBuscarXML_Click" />
                                    </div>
                                </div>   
                            </div>
                        </asp:Panel>
        ...
        <ProgressTemplate>
            <div class="Sending">
                <div id="ParentDiv" align="center" valign="middle" runat="server" style="position: absolute; left: 50%; top: 25%; visibility: visible; vertical-align: middle; z-index: 40;">
                    ...
                    <%--<img src="assets/images/icons/Validate_1.gif" width="100" height="100"/><br />
                    <br />
                    <p style="color: #dddddd">Validando Documento...</p>
                    <br />
