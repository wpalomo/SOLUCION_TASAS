<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="frmPreciosPasajes.aspx.cs" Inherits="Solution_CTT.frmPreciosPasajes" %>
                ...
                <div class="row">
                            ...
                            <div class="box-body">
                                <asp:GridView ID="dgvDatos" runat="server" class="mGrid" AutoGenerateColumns="False" EmptyDataText="No hay Registros o Coindicencias..!!" OnSelectedIndexChanged="dgvDatos_SelectedIndexChanged" AllowPaging="true" PageSize="8" OnPageIndexChanging="dgvDatos_PageIndexChanging" OnRowDataBound="dgvDatos_RowDataBound">
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="IIDORIGEN" HeaderText="ID ORIGEN" />
                                        <asp:BoundField DataField="IIDDESTINO" HeaderText="ID DESTINO" />
                    ...
                    <div class="col-md-4">
                        <div class="box box-success">
                            <div class="box-header with-border">
                                <h3 class="box-title"><%= Resources.MESSAGES.TXT_ANDENES %></h3>
                                <div class="box-tools pull-right">
                                    ...
                                    <div class="row">
                                        <div class="col-md-offset-1 col-md-10">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <asp:DropDownList ID="cmbOrigen" runat="server" class="form-control" AutoPostBack="True" OnSelectedIndexChanged="cmbOrigen_SelectedIndexChanged"></asp:DropDownList>                                                        
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                            ...
                                            <div class="form-group has-feedback">
                                                <asp:TextBox ID="txtCodigo" runat="server" CssClass="form-control" placeholder="Código *" ToolTip="Ingrese un código"></asp:TextBox>
                                            </div>
                                            <div class="form-group has-feedback">
                                                <asp:TextBox ID="txtDescripcion" runat="server" CssClass="form-control" placeholder="Descripción *" ToolTip="Ruta Seleccionada" ReadOnly="true">NINGUNO - NINGUNO</asp:TextBox>
                                            </div>
                                            <div class="form-group has-feedback">
                                                <asp:TextBox ID="txtValor" runat="server" CssClass="form-control" placeholder="Costo Pasaje *" ToolTip="Ingrese el precio del pasaje"></asp:TextBox>
                                            </div>
                                            <div class="form-group has-feedback">
                                                <asp:CheckBox ID="chkPagaIva" runat="server" class="form-control" Text="&nbsp;&nbsp;¿Paga IVA?" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
