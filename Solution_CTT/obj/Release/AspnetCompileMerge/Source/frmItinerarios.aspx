<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="frmItinerarios.aspx.cs" Inherits="Solution_CTT.frmItinerarios" %>
              ...
              <div class="row">
                    ...
                    <div class="box-header with-border">
                      ...
                      <div class="box-tools pull-right">                                
                          <div class="input-group input-group-sm" style="width: 150px;">                          
                              <asp:TextBox ID="txtFiltrar" runat="server" class="form-control pull-right" placeholder="CÓDIGO"></asp:TextBox>
               ...
               <div class="col-md-4">
                        <div class="box box-success">
                            <div class="box-header with-border">
                                <h3 class="box-title"><%= Resources.MESSAGES.TXT_RUTA %></h3>
                                <div class="box-tools pull-right">
                                ...
                                <div class="register-box-body">
                                    <div class="row">
                                        <div class="col-md-offset-1 col-md-10">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <asp:DropDownList ID="cmbLocalidad" runat="server" class="form-control" AutoPostBack="True" OnSelectedIndexChanged="cmbLocalidad_SelectedIndexChanged"></asp:DropDownList>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <asp:DropDownList ID="cmbRutas" runat="server" class="form-control"></asp:DropDownList>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <asp:DropDownList ID="cmbHoraSalida" runat="server" class="form-control"></asp:DropDownList>
                                                    </div>
                                                </div>
                                            </div>                                            

                                            <div class="form-group has-feedback">
                                                <asp:TextBox ID="txtCodigo" runat="server" ReadOnly="true" autocomplete="off" CssClass="form-control" placeholder="Código *"></asp:TextBox>
                                            </div>
                                            <%--<div class="form-group has-feedback">
                                    ...
                                    <div class="row">
                                        <div class="col-md-offset-1 col-md-5">
                                            <div class="form-group">
                                                <asp:Button ID="btnCancelar" runat="server" Text="Cancelar" class="btn btn-sm btn-default btn-block pull-right" OnClick="btnCancelar_Click" />
                                            </div>
                                        </div>
                                        <div class=" col-md-5">
                                            <div class="form-group">
                                                <asp:Button ID="btnGuardar" runat="server" Text="Crear" class="btn btn-sm btn-primary btn-block pull-right" OnClick="btnGuardar_Click" />
                                            </div>
                                        </div>
                                    </div>
                                    <br />
