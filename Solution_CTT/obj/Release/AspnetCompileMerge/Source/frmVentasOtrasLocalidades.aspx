<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="frmVentasOtrasLocalidades.aspx.cs" Inherits="Solution_CTT.frmVentasOtrasLocalidades" %>
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-10">
                                    ...
                                    <LocalReport ReportEmbeddedResource="Solution_CTT.Reportes.rptListaPasajeros.rdlc">
                                    </LocalReport>
                                    </rsweb:ReportViewer>
                                    <br />
                                </div>
