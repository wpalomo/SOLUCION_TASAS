<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="frmRutas.aspx.cs" Inherits="Solution_CTT.frmRutas" %>
                  ...
                  <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <asp:GridView ID="dgvDatos" runat="server" class="mGrid" AutoGenerateColumns="False" EmptyDataText="No hay Registros o Coindicencias..!!" OnSelectedIndexChanged="dgvDatos_SelectedIndexChanged" AllowPaging="true" PageSize="8" OnPageIndexChanging="dgvDatos_PageIndexChanging" OnRowDataBound="dgvDatos_RowDataBound">
                            <Columns>
                                <asp:BoundField DataField="IIDRUTA" HeaderText="ID" />
                                <asp:BoundField DataField="IIDTERMINALORIGEN" HeaderText="ID ORIGEN" />
                                <asp:BoundField DataField="IIDTERMINALDESTINO" HeaderText="ID DESTINO" />
                                <asp:BoundField DataField="ICODIGO" HeaderText="CÓDIGO" ItemStyle-HorizontalAlign="Center" />
                                <asp:BoundField DataField="ITERMINALORIGEN" HeaderText="ORIGEN" />
                                    ...
                                    <div class="row">
                                        <div class="col-md-offset-1 col-md-10">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <asp:DropDownList ID="cmbTerminalOrigen" runat="server" class="form-control"></asp:DropDownList>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <asp:DropDownList ID="cmbTerminalDestino" runat="server" class="form-control"></asp:DropDownList>
                                                    </div>
                                                </div>
                                            </div>
