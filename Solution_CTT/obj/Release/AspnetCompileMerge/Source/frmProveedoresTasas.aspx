<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="frmProveedoresTasas.aspx.cs" Inherits="Solution_CTT.frmProveedoresTasas" %>
                  ...
                  <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <asp:GridView ID="dgvDatos" runat="server" class="mGrid" AutoGenerateColumns="False" EmptyDataText="No hay Registros o Coindicencias..!!" OnSelectedIndexChanged="dgvDatos_SelectedIndexChanged" AllowPaging="true" PageSize="8" OnPageIndexChanging="dgvDatos_PageIndexChanging">
                            <Columns>
                                <asp:BoundField DataField="id_ctt_proveedor_tasa" HeaderText="ID" />
                                ...
                                <asp:BoundField DataField="proveedor" HeaderText="NOMBRE PROVEEDOR"  />
                                <asp:BoundField DataField="descripcion" HeaderText="DESCRIPCIÓN"  />
                                <asp:BoundField DataField="estado" HeaderText="ESTADO" ItemStyle-HorizontalAlign="Center" />
                                <asp:BoundField DataField="estado_corto" HeaderText="ESTADO" />
                                ...
                                <div class="register-box-body">
                                    <div class="row">
                                        <div class="col-md-offset-1 col-md-10">
                                            ...
                                            <div class="form-group has-feedback">
                                                <asp:TextBox ID="TxtPersona" ReadOnly="true" runat="server" CssClass="form-control" placeholder="Proveedor *"></asp:TextBox>
                                            </div>
                                            <div class="form-group has-feedback">                                                       
                                                <asp:LinkButton ID="btnAbrirModalPersonas" runat="server" Text="" class="btn btn-block btn-success" OnClick="btnAbrirModalPersonas_Click"><i class="fa fa-search"> BUSCAR PROVEEDOR</i></asp:LinkButton>
                                            </div>
                                            <div class="form-group has-feedback">                                                       
        ...
        <ContentTemplate>
                <div class="modal-content">
                    <div class="modal-header bg-teal-active color-palette">
                        ...
                        <h4 class="modal-title" id="myModalLabel5">Registros de Personas</h4>
                    </div>
                    <div class="modal-body">
