<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="frmTipoViajes.aspx.cs" Inherits="Solution_CTT.frmTipoViajes" %>
                  ...
                  <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <asp:GridView ID="dgvDatos" runat="server" class="mGrid" AutoGenerateColumns="False" EmptyDataText="No hay Registros o Coindicencias..!!" OnSelectedIndexChanged="dgvDatos_SelectedIndexChanged" AllowPaging="true" PageSize="8" OnPageIndexChanging="dgvDatos_PageIndexChanging" OnRowDataBound="dgvDatos_RowDataBound">
                            <Columns>
                                <asp:BoundField DataField="IIDMODOVIAJE" HeaderText="ID" />
                                ...
                                <asp:BoundField DataField="IEDITARPRECIO" HeaderText="EDITAR PRECIO" ItemStyle-HorizontalAlign="Center"  />
                            ...
                            <div class="register-box-body">
                                <div class="row">
                                    <div class="col-md-offset-1 col-md-10">
                                        ...
                                        <div class="form-group has-feedback">
                                            <asp:CheckBox ID="chkEditarPrecio" runat="server" Text="&nbsp&nbspPermitir editar el precio" />
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
