<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="frmTipoComprobante.aspx.cs" Inherits="Solution_CTT.frmTipoComprobante" %>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="box box-success">
                            <div class="box-header with-border">
                                <h3 class="box-title"><%= Resources.MESSAGES.TXT_TIPO_COMPROBANTES %></h3>
                                <div class="box-tools pull-right">
                                    ...
                                    <div class="row">
                                        <div class="col-md-offset-1 col-md-10">
                                            <div class="form-group has-feedback">
                                                <asp:TextBox ID="txtCodigo" runat="server" CssClass="form-control" placeholder="Código *" AutoComplete="off" onkeypress="return validar_numeros(event)"></asp:TextBox>
                                            </div>
                                            <div class="form-group has-feedback">
