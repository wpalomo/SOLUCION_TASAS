<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="frmCrearViaje.aspx.cs" Inherits="Solution_CTT.frmCrearViaje" %>
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="box box-primary">
                                ...
                                <div class="box-body">
                                    <asp:GridView ID="dgvDatos" runat="server" class="mGrid" AutoGenerateColumns="False" EmptyDataText="No hay Registros o Coindicencias..!!" AllowPaging="true" PageSize="12" OnPageIndexChanging="dgvDatos_PageIndexChanging" OnSelectedIndexChanged="dgvDatos_SelectedIndexChanged" OnRowDataBound="dgvDatos_RowDataBound">
                                        <Columns>
                                ...
                                <div class="box-body">
                                    <div class="form-group">
                                        ...
                                        <div class="row">
                                            ...
                                            <asp:Panel ID="pnlVehiculoReemplazo" runat="server" Visible="false">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <asp:Label ID="Label7" runat="server" Text="Vehículo de reemplado"></asp:Label>
                                                        <div class="input-group col-sm-12">
                                                            <asp:TextBox ID="txtVehiculoReemplazo" ReadOnly="true" runat="server" CssClass="form-control input-sm" placeholder="Vehículo de Reemplazo *" BackColor="White"></asp:TextBox>
                                                            <span class="input-group-addon input-sm"><asp:LinkButton ID="btnAbrirModalVehiculoReemplazo" runat="server" Text="" OnClick="btnAbrirModalVehiculoReemplazo_Click" tooltip="Seleccionar Vehículo de Reemplazo"><i class="fa fa-search"></i></asp:LinkButton></span>
                                                            <span class="input-group-addon input-sm"><asp:LinkButton ID="btnRemoverVehiculoReemplazo" runat="server" Text="" OnClick="btnRemoverVehiculoReemplazo_Click" ToolTip="Clic aquí para remover el vehículo seleccionado"><i class="fa fa-eraser"></i></asp:LinkButton></span>
                                                        </div>                                                
                                                    </div>
                                                </div>
                                            </asp:Panel>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-10">
                                            <asp:Label ID="Label8" runat="server" Text="Desea eliminar el registro, puede que no sea recuperable"></asp:Label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">                                           
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-12">
                                    <asp:GridView ID="dgvExtras" runat="server" class="mGrid" AutoGenerateColumns="False" EmptyDataText="No hay Registros o Coindicencias..!!" OnRowDataBound="dgvExtras_RowDataBound">
                                        <Columns>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-12">
                                    <asp:GridView ID="dgvVehiculos" runat="server" class="mGrid" AutoGenerateColumns="False" EmptyDataText="No hay Registros o Coindicencias..!!" AllowPaging="True" PageSize="10" OnSelectedIndexChanged="dgvVehiculos_SelectedIndexChanged" OnPageIndexChanging="dgvVehiculos_PageIndexChanging" OnRowDataBound="dgvVehiculos_RowDataBound">
                                        <Columns>
                                            <asp:BoundField DataField="INUMERO" HeaderText="No."  />
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header bg-teal-active color-palette">
                        ...
                        <h4 class="modal-title" id="myModalLabel17">Itinerarios</h4>
                    </div>
                    <div class="modal-body">
