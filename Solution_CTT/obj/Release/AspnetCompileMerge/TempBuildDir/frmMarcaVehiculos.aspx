<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="frmMarcaVehiculos.aspx.cs" Inherits="Solution_CTT.frmMarcaVehiculos" %>
              ...
              <div class="row">
               ...
               <div class="col-md-4">
                        <div class="box box-success">
                            <div class="box-header with-border">
                                <h3 class="box-title"><%= Resources.MESSAGES.TXT_MARCA_VEHICULO %></h3>
                                <div class="box-tools pull-right">
