<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="frmAndenes.aspx.cs" Inherits="Solution_CTT.frmAndenes" %>
                        ...
                        <div class="box box-primary">
                            ...
                            <div class="box-body">
                                <asp:GridView ID="dgvDatos" runat="server" class="mGrid" AutoGenerateColumns="False" EmptyDataText="No hay Registros o Coindicencias..!!" OnSelectedIndexChanged="dgvDatos_SelectedIndexChanged" AllowPaging="true" PageSize="8" OnPageIndexChanging="dgvDatos_PageIndexChanging" OnRowDataBound="dgvDatos_RowDataBound">
                                    <Columns>
                                        <asp:BoundField DataField="IIDANDEN" HeaderText="ID" />
                                        ...
                                        <asp:BoundField DataField="INUMERACION" HeaderText="No. ANDEN" />
                                        <asp:BoundField DataField="IESTADO" HeaderText="ESTADO" />
                                        <asp:BoundField DataField="IPRINCIPAL" HeaderText="PRINCIPAL" />
                                ...
                                <div class="register-box-body">
                                    <div class="row">
                                        <div class="col-md-offset-1 col-md-10">
                                            ...
                                            <div class="form-group has-feedback">
                                                <asp:TextBox ID="txtNumeracion" runat="server" CssClass="form-control" placeholder="Número Andén *" onkeypress="return validar_numeros(event)" autocomplete="off"></asp:TextBox>
                                            </div>
                                            <div class="form-group has-feedback">
                                            ...
                                            <div class="form-group has-feedback">
                                                <asp:CheckBox ID="chkPrincipal" runat="server" Text="&nbsp;&nbsp;Anden Principal" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
