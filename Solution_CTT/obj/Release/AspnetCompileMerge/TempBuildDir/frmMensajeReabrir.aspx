<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmMensajeReabrir.aspx.cs" Inherits="Solution_CTT.frmMensajeReabrir" %>
						...
						<div class="card-body">
							...
							<form id="form1" runat="server">							 
                                <div class="form-group">
									<label for="email">Se ha reaperturado la caja de forma exitosa. Favor ingrese su usuario nuevamente.</label>
								</div>
