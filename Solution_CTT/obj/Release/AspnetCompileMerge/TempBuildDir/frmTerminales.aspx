<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="frmTerminales.aspx.cs" Inherits="Solution_CTT.frmTerminales" %>
                ...
                <div class="row">
                            ...
                            <div class="box-body">
                                <asp:GridView ID="dgvDatos" runat="server" class="mGrid" AutoGenerateColumns="False" EmptyDataText="No hay Registros o Coindicencias..!!" OnSelectedIndexChanged="dgvDatos_SelectedIndexChanged" AllowPaging="true" PageSize="8" OnPageIndexChanging="dgvDatos_PageIndexChanging">
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="IIDLOCALIDAD" HeaderText="ID" />
                                        ...
                                        <asp:BoundField DataField="INOMBRELOCALIDAD" HeaderText="LOCALIDAD" />
                    ...
                    <div class="col-md-4">
                        <div class="box box-success">
                            <div class="box-header with-border">
                                <h3 class="box-title"><%= Resources.MESSAGES.TXT_TERMINAL %></h3>
                                <div class="box-tools pull-right">
                                ...
                                <div class="register-box-body">
                                    <div class="row">
                                        <div class="col-md-offset-1 col-md-10">
                                            ...
                                            <div class="form-group has-feedback">
                                                <asp:TextBox ID="txtDescripcion" runat="server" CssClass="form-control" placeholder="Descripción del Terminal * "></asp:TextBox>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <asp:TextBox ID="txtDireccion" runat="server" CssClass="form-control" placeholder="Dirección del Terminal *"></asp:TextBox>
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    <div class="form-group">
