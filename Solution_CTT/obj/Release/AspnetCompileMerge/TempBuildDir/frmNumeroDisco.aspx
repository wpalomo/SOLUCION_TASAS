<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="frmNumeroDisco.aspx.cs" Inherits="Solution_CTT.frmNumeroDisco" %>
                ...
                <div class="col-md-8">
                  ...
                  <div class="col-md-4">
                        <div class="box box-success">
                            <div class="box-header with-border">
                                <h3 class="box-title"><%= Resources.MESSAGES.TXT_NUMERO_DISCO %></h3>
                                <div class="box-tools pull-right">
