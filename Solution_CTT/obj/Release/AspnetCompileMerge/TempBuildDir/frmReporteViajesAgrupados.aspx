<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="frmReporteViajesAgrupados.aspx.cs" Inherits="Solution_CTT.frmReporteViajesAgrupados" %>
                            ...
                            <div class="box-body">
                                <div class="row">
                                    <div class="form-group col-md-3">
                                        ...
                                        <%--<asp:TextBox ID="txtFechaDesde" runat="server" class="form-control" autocomplete="off" type="date" placeholder="Buscar"></asp:TextBox>--%>
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <%--<asp:TextBox ID="txtFechaHasta" runat="server" class="form-control" autocomplete="off" type="date" placeholder="Buscar"></asp:TextBox>--%>
                                    ...
                                    <div class="form-group col-md-2">
                                        ...
                                        <asp:DropDownList ID="cmbTransporte" runat="server" class="form-control"></asp:DropDownList>
                                    </div>
                                    <div class="form-group col-md-2">
                                        <label for="exampleInputEmail1">Ruta</label>
                                        <asp:DropDownList ID="cmbRuta" runat="server" class="form-control"></asp:DropDownList>
                                    </div>
                                    <div class="form-group col-md-2">
                                        <label for="exampleInputEmail1">Usuario</label>
                                        <asp:DropDownList ID="cmbUsuario" runat="server" class="form-control"></asp:DropDownList>
                                    </div>
                                </div>                                
                            </div>
                            <div class="box-footer">
                                <asp:LinkButton ID="btnConsultar" runat="server" Text="" class="btn btn-success" OnClick="btnConsultar_Click"><i class="fa fa-search"> CONSULTAR</i></asp:LinkButton>
                                <asp:LinkButton ID="btnLimpiar" runat="server" Text="" class="btn btn-default" OnClick="btnLimpiar_Click"><i class="fa fa-eraser"> CANCELAR</i></asp:LinkButton>                                                                
                                <asp:LinkButton ID="btnImprimir" runat="server" Text="" class="btn btn-danger" OnClick="btnImprimir_Click" Visible="false" ><i class="fa fa-print"> VISUALIZAR REPORTE</i></asp:LinkButton>                                    
                            </div>
                        </div>
                    </div>
                    <%--GRID--%>
                            ...
                            <div class="box-body">
                                <asp:GridView ID="dgvDatos" runat="server" class="mGrid" AutoGenerateColumns="False" EmptyDataText="No hay Registros o Coindicencias..!!" AllowPaging="true" OnPageIndexChanging="dgvDatos_PageIndexChanging" PageSize="20" OnRowDataBound="dgvDatos_RowDataBound">
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="IFECHA_VIAJE" HeaderText="FECHA" ItemStyle-HorizontalAlign="Center" />
                                        <asp:BoundField DataField="IRUTA" HeaderText="RUTA" ItemStyle-HorizontalAlign="Center" />
                                        <asp:BoundField DataField="IUSUARIO" HeaderText="USUARIO" ItemStyle-HorizontalAlign="Center" />
                                        <asp:BoundField DataField="IVALOR" HeaderText="TOTAL VENTAS" ItemStyle-HorizontalAlign="Right" />
                                        <asp:BoundField DataField="ICUENTA" HeaderText="ASI. VENDIDOS" ItemStyle-HorizontalAlign="Center" />
                                    </Columns>
            ...
            <div class="modal-dialog modal-lg" role="document">--%>
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel5">Reporte de Viajes Agrupados por Transporte</h4>
                    </div>
                    <div class="modal-body">
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-10">
                                    <rsweb:ReportViewer ID="rptViajeAgrupados" runat="server" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Height="400px" Width="900px">
                                    <LocalReport ReportEmbeddedResource="Solution_CTT.Reportes.rptViajesAgrupados.rdlc">
                                    </LocalReport>
                                    </rsweb:ReportViewer>
                                    <br />
                                </div>
