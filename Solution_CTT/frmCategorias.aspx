<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="frmCategorias.aspx.cs" Inherits="Solution_CTT.frmCategorias" %>
                ...
                <div class="row">
                        ...
                        <div class="box box-primary">
                            ...
                            <div class="box-body">
                                <asp:GridView ID="dgvDatos" runat="server" class="mGrid" AutoGenerateColumns="False" EmptyDataText="No hay Registros o Coindicencias..!!" OnSelectedIndexChanged="dgvDatos_SelectedIndexChanged" AllowPaging="true" PageSize="8" OnPageIndexChanging="dgvDatos_PageIndexChanging">
                                    <Columns>
                                        <asp:BoundField DataField="IIDPRODUCTO" HeaderText="ID" />
                                        ...
                                        <asp:BoundField DataField="IPUEBLO" HeaderText="ORIGEN" />
                                        <asp:BoundField DataField="IMODIFICABLE" HeaderText="MODIFICABLE" />
                                        <asp:BoundField DataField="IPRECIOMODIFICABLE" HeaderText="PRECIO MODIFICABLE" />
                                        <asp:BoundField DataField="IPAGAIVA" HeaderText="PAGA IVA" />
                                        <asp:BoundField DataField="IUNIDADCONSUMO" HeaderText="SUBCATEGORIA" />
                                        <asp:BoundField DataField="IAPLICAEXTRA" HeaderText="EXTRA" />
                                        <asp:BoundField DataField="ITICKET" HeaderText="TICKET" />
                    ...
                    <div class="col-md-4">
                        <div class="box box-success">
                            <div class="box-header with-border">
                                <h3 class="box-title"><%= Resources.MESSAGES.TXT_CATEGORIAS %></h3>
                                <div class="box-tools pull-right">
                                ...
                                <div class="register-box-body">
                                    <div class="row">
                                        <div class="col-md-offset-1 col-md-10">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <asp:DropDownList ID="cmbProductoPadre" runat="server" class="form-control input-sm"></asp:DropDownList>                                                        
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <asp:DropDownList ID="cmbOrigen" runat="server" class="form-control input-sm"></asp:DropDownList>                                                        
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                            ...
                                            <div class="form-group has-feedback">
                                                <asp:TextBox ID="txtDescripcion" runat="server" CssClass="form-control input-sm" autocomplete="off" placeholder="Descripción *"></asp:TextBox>                                                
                                            </div>
                                            <div class="form-group has-feedback">
                                                <asp:CheckBox ID="chkModificable" runat="server" Text="&nbsp;&nbsp;Modificable" />
                                            </div>
                                            <div class="form-group has-feedback">
                                            ...
                                            <div class="form-group has-feedback">
                                                <asp:CheckBox ID="chkAplicaExtra" runat="server" Text="&nbsp;&nbsp;Aplica Extra" />
                                            </div>
                                            <div class="form-group has-feedback">
                                                <asp:CheckBox ID="chkTickets" runat="server" Text="&nbsp;&nbsp;Para cobro administrativo" />
                                            </div>
<%--                                            <div class="form-group has-feedback">
                                                <asp:CheckBox ID="chkSubcategoria" runat="server" Text="&nbsp;&nbsp;Tiene Subcategorías" />
                                            </div>--%>
                                        </div>
                                    </div>
                                    <div class="row">
