...
{
    public partial class frmReportePasajerosBus : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Session["modulo"] = "MÓDULO DE PASAJEROS POR VEHÍCULO";
            ...
            try
            {
                ...
                if (bRespuesta == true)
                {
                    ...
                    else
                    {
                        ...
                        rptReportePasajerosBus.LocalReport.ReportPath = Server.MapPath("~/Reportes/rptListaPasajeros.rdlc");
        ...
        protected void btnImprimirReporte_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                manifiesto.llenarReporte(Convert.ToInt32(Session["idProgramacion"]), Session["usuario"].ToString(), 0, 0, 0, 0);
            }
