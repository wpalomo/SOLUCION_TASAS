<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="frmPueblos.aspx.cs" Inherits="Solution_CTT.frmPueblos" %>
                ...
                <div class="row">
                            ...
                            <div class="box-body">
                                <asp:GridView ID="dgvDatos" runat="server" class="mGrid" AutoGenerateColumns="False" EmptyDataText="No hay Registros o Coindicencias..!!" OnSelectedIndexChanged="dgvDatos_SelectedIndexChanged" AllowPaging="true" PageSize="8" OnPageIndexChanging="dgvDatos_PageIndexChanging" OnRowDataBound="dgvDatos_RowDataBound">
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="IIDLOCALIDADTERMINAL" HeaderText="ID" />
                                        <asp:BoundField DataField="IIDLOCALIDADENCOMIENDA" HeaderText="ID" />
                                        <asp:BoundField DataField="IIDPROVINCIA" HeaderText="ID" />
                                        <asp:BoundField DataField="IDESCRIPCION" HeaderText="OFICINAS" />
                                        <asp:BoundField DataField="IPROVINCIA" HeaderText="PROVINCIA" />
                                        <asp:BoundField DataField="ITERMINAL" HeaderText="TERMINAL" ItemStyle-HorizontalAlign="Center" />
                                        <asp:BoundField DataField="IENCOMIENDA" HeaderText="ENCOMIENDA" ItemStyle-HorizontalAlign="Center" />
                                        <asp:BoundField DataField="ICOBROSADMINISTRACION" HeaderText="COBROS" ItemStyle-HorizontalAlign="Center" />
                                        <asp:BoundField DataField="ICOBROSOTROS" HeaderText="COBROS" ItemStyle-HorizontalAlign="Center" />
                    ...
                    <div class="col-md-4">
                        <div class="box box-success">
                            <div class="box-header with-border">
                                <h3 class="box-title"><%= Resources.MESSAGES.TXT_PUEBLOS %></h3>
                                <div class="box-tools pull-right">
                                ...
                                <div class="register-box-body">
                                    <div class="row">
                                        <div class="col-md-offset-1 col-md-10">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <asp:DropDownList ID="cmbProvincia" runat="server" class="form-control"></asp:DropDownList>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group has-feedback">
                                                <asp:CheckBox ID="chkCobrosAdministracion" runat="server" Text="&nbsp;&nbsp;Realiza cobros administración" />
                                            </div>

                                            <div class="form-group has-feedback">
                                                <asp:CheckBox ID="chkCobrosOtros" runat="server" Text="&nbsp;&nbsp;Realiza otros cobros" />
                                            </div>

                                            <div class="form-group has-feedback">
                                                <asp:CheckBox ID="chkAplicaTerminal" runat="server" Text="&nbsp;&nbsp;Aplica Terminal" AutoPostBack="true" OnCheckedChanged="chkAplicaTerminal_OnCheckedChanged" />
                                            </div>

                                            <asp:Panel ID="pnlTerminal" runat="server" Visible="false">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                            ...
                                            <div class="form-group has-feedback">
                                                <asp:CheckBox ID="chkAplicaEncomienda" runat="server" Text="&nbsp;&nbsp;Aplica Encomiendas" AutoPostBack="true" OnCheckedChanged="chkAplicaEncomienda_OnCheckedChanged" />
                                            </div>
                                            ...
                                            <asp:Panel ID="pnlEncomienda" runat="server" Visible="false">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <asp:DropDownList ID="cmbLocalidadEncomienda" runat="server" class="form-control"></asp:DropDownList>                                                        
                                                        </div>
                                                    </div>
                                                </div>
                                            </asp:Panel>                                           
