<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmPermisos.aspx.cs" Inherits="Solution_CTT.frmPermisos" %>
						...
						<div class="card-body">
							...
							<form id="form1" runat="server">							 
                                <div class="form-group">
									<label for="email"><%= Resources.MESSAGES.TXT_PERMISOS %></label>
								</div>
                              
								<div class="form-group no-margin">
                                    <asp:Button ID="btnRegresar" runat="server" Text="Volver al Inicio" class="btn btn-primary btn-block" TabIndex="4" OnClick="btnRegresar_Click"/>                                    
								</div>
							</form>
						</div>
					</div>
