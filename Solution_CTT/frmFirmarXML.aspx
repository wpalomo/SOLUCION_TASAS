<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="frmFirmarXML.aspx.cs" Inherits="Solution_CTT.frmFirmarXML" %>
                    ...
                    <div class="col-md-12">
                        <div class="box box-primary">
                            <div class="box-header with-border">
                                ...
                                <h3 class="box-title">Firmar XML</h3>
                            </div>
                            <div class="box-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-3 form-group">
                                        ...
                                        <div class="input-group col-sm-12">
                                            <asp:DropDownList ID="cmbTipoCertificadoDigital" runat="server" disabled="" class="form-control input-sm"></asp:DropDownList>                                            
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 form-group">
                                        ...
                                        <div class="input-group col-sm-12">
                                            <asp:TextBox ID="txtClaveAcceso" runat="server" class="form-control input-sm" placeholder="" AutoComplete="off" ToolTip=""></asp:TextBox>
                                            <span class="input-group-addon input-sm"><i class="fa fa-dollar"></i></span>
                                        </div>
                                    </div>
                                    <div class="col-md-3 form-group">
                                        ...
                                        <div class="input-group col-sm-12">
                                            <asp:TextBox ID="txtNumeroDocumento" runat="server" class="form-control input-sm" placeholder="" AutoComplete="off" ToolTip=""></asp:TextBox>
                                            <span class="input-group-addon input-sm"><i class="fa fa-dollar"></i></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-3 form-group">
                                        <label>Ruta de archivos generados</label>
                                        <div class="input-group col-sm-12">
                                            <asp:TextBox ID="txtRutaGenerados" runat="server" class="form-control input-sm" placeholder="" AutoComplete="off" ToolTip=""></asp:TextBox>
                                            <span class="input-group-addon input-sm"><i class="fa fa-dollar"></i></span>
                                        </div>
                                    </div>
                                    <div class="col-md-3 form-group">
                                        ...
                                        <div class="input-group col-sm-12">
                                            <asp:TextBox ID="txtRutaFirmados" runat="server" class="form-control input-sm" placeholder="" AutoComplete="off" ToolTip=""></asp:TextBox>
                                            <span class="input-group-addon input-sm"><i class="fa fa-dollar"></i></span>
                                        </div>
                                    </div>
                                    <div class="col-md-3 form-group">
                                        ...
                                        <div class="input-group col-sm-12">
                                            <asp:TextBox ID="txtDocumentoFirmar" runat="server" class="form-control input-sm" placeholder="" AutoComplete="off" ToolTip=""></asp:TextBox>
                                            <span class="input-group-addon input-sm"><i class="fa fa-dollar"></i></span>
                                        </div>
                                    </div>                                 
                                </div>
                                <div class="row">
                                    <div class="col-md-3 form-group">
                                        <label></label>
                                        <div class="input-group col-sm-12">
                                            <asp:LinkButton ID="lbtnFirmarXML" runat="server" class="form-control btn btn-flat btn-primary" ToolTip="Clic aquí, para firmar XML" OnClick="lbtnFirmarXML_Click" ><i class="fa fa-pencil-square-o"></i>  Firmar XML</asp:LinkButton>
                                        </div>
                                    </div>
                                    <div class="col-md-3 form-group">
                                        <label></label>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <asp:GridView ID="dgvFiltrarModalBuscarXML" runat="server" class="mGrid" AutoGenerateColumns="False" 
                                        ...
                                        OnSelectedIndexChanged="dgvFiltrarModalBuscarXML_SelectedIndexChanged" OnPageIndexChanging="dgvFiltrarModalBuscarXML_PageIndexChanging">
                                        <Columns>
        ...
        <ProgressTemplate>
            <div class="Sending">
                <div id="ParentDiv" align="center" valign="middle" runat="server" style="position: absolute; left: 50%; top: 25%; visibility: visible; vertical-align: middle; z-index: 40;">
                    ...
                    <%--<br />
                    <p style="color: #dddddd">Firmando Documento...</p>
                    <br />
