<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="frmAsistentes.aspx.cs" Inherits="Solution_CTT.frmAsistentes" %>
                ...
                <div class="row">
                        ...
                        <div class="box box-primary">
                            ...
                            <div class="box-body">
                                <asp:GridView ID="dgvDatos" runat="server" class="mGrid" AutoGenerateColumns="False" EmptyDataText="No hay Registros o Coindicencias..!!" OnSelectedIndexChanged="dgvDatos_SelectedIndexChanged" AllowPaging="true" PageSize="8" OnPageIndexChanging="dgvDatos_PageIndexChanging" OnRowDataBound="dgvDatos_RowDataBound" >
                                    <Columns>
                                        <asp:BoundField DataField="IIDASISTENTE" HeaderText="ID" />
                  ...
                  <div class="col-md-4">
                        <div class="box box-success">
                            <div class="box-header with-border">
                                <h3 class="box-title"><%= Resources.MESSAGES.TXT_ASISTENTES %></h3>
                                <div class="box-tools pull-right">
                                ...
                                <div class="register-box-body">
                                    <div class="row">
                                        <div class="col-md-offset-1 col-md-10">
                                            ...
                                            <div class="form-group has-feedback">
                                                <asp:TextBox ID="TxtPersona" ReadOnly="true" runat="server" CssClass="form-control" autocomplete="off" placeholder="ASISTENTE *" ToolTip="Debe buscar un asistente, haciendo click en el boton verde buscar asistente"></asp:TextBox>
                                            </div>
                                            <div class="form-group has-feedback">
                                                <asp:LinkButton ID="btnAbrirModalPersonas" runat="server" Text="" class="btn btn-block btn-success" OnClick="btnAbrirModalPersonas_Click"><i class="fa fa-search"> BUSCAR ASISTENTE</i></asp:LinkButton>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
