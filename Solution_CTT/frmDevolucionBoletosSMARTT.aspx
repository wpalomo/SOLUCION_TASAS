<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="frmDevolucionBoletosSMARTT.aspx.cs" Inherits="Solution_CTT.frmDevolucionBoletosSMARTT" %>
                                ...
                                <div class="box-body">
                                    <asp:GridView ID="dgvDatos" runat="server" class="mGrid"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="IIDVIAJECONTIFICO" HeaderText="ID CONTIFICO" />
                            ...
                            <div class="box box-primary">
                                ...
                                <div class="box-body">
                                    <asp:GridView ID="dgvVendidos" runat="server" class="mGrid"
                                        AutoGenerateColumns="False"
                                        EmptyDataText="No hay Registros o Coindicencias..!!"
                                        OnSelectedIndexChanged="dgvVendidos_SelectedIndexChanged" AllowPaging="True" OnPageIndexChanging="dgvVendidos_PageIndexChanging" PageSize="15">
                                        <Columns>
